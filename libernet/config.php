    ...
    <div class="container">
        <div class="row py-2">
            <div class="col-lg-8 col-md-12 mx-auto ">
                <div class="card block moving-glow" style="margin-top:20px">
                            ...
                            <div class="form-group form-row my-auto">
                                ...
                                <div class="col-lg-4 col-md-3 form-row py-1">
                                    <div class="col d-flex">
                                        <button type="submit" class="btn btn-outline-info mr-1">Load</button>
                                        <button type="button" class="btn btn-outline-danger ml-1" @click="deleteConfig">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="card-body">
                        <form @submit.prevent="saveConfig">
                            ...
                            <div v-if="config.temp.mode === 0" class="ssh pb-lg-2">
                                <div v-if="config.temp.modes[0].profile.enable_http" class="proxy">
                                    ...
                                    <div class="form-group">
                                        <label>Payload</label>
                                        <textarea style="text-align:left" class="form-control" v-model="config.temp.modes[0].profile.http.payload" rows="5" placeholder="GET http://libernet.tld/ HTTP/1.1[crlf][crlf]CONNECT [host_port] HTTP/1.1[crlf]Connection: keep-allive[crlf][crlf]" required></textarea>
                                    </div>
                                </div>
                                <div class="form-row pb-lg-2">
                                    <div class="col-md-6">
                            ...
                            <div v-if="config.temp.mode === 1" class="v2ray">
                                <div v-if="config.temp.modes[1].profile.protocol === 'vmess'" class="form-row pt-lg-2 pb-lg-2 v2ray-vmess">
                                    <div class="col">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button type="button" class="btn btn-outline-primary ml-1" @click="importV2rayConfig">Import</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row pb-lg-2">
                                ...
                                <div v-if="config.temp.modes[1].profile.protocol === 'vmess'" class="form-row pb-lg-2 v2ray-vmess">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="custom-select form-control" v-model="config.temp.modes[1].profile.server.user.vmess.security" required>
                                ...
                                <div class="form-row pb-lg-2">
                                    <div class="col-md-2">
                                        <label>Network</label>
                                        <select class="custom-select form-control" v-model="config.temp.modes[1].profile.network" required>
                                            <option v-for="network in config.temp.modes[1].networks" :value="network.value">{{ network.name }}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Security</label>
                                        <select v-if="config.temp.modes[1].profile.network === 'tcp'" class="custom-select form-control" v-model="config.temp.modes[1].profile.security" required>
                                            <option :value="config.temp.modes[1].securities[1].value">{{ config.temp.modes[1].securities[1].name }}</option>
                                        </select>
                                        <select v-else-if="config.temp.modes[1].profile.network === 'http'" class="custom-select form-control" v-model="config.temp.modes[1].profile.security" required>
                                            <option :value="config.temp.modes[1].securities[0].value">{{ config.temp.modes[1].securities[0].name }}</option>
                                        </select>
                                        <select v-else class="custom-select form-control" v-model="config.temp.modes[1].profile.security" required>
                                ...
                                <div class="form-row pt-lg-2 pb-lg-2">
                                    <div class="col">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button type="button" class="btn btn-outline-primary ml-1" @click="importTrojanConfig">Import</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row pb-lg-2">
                                ...
                                <div class="form-row pt-lg-2 pb-lg-2">
                                    <div class="col">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button type="button" class="btn btn-outline-primary ml-1" @click="importShadowsocksConfig">Import</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row pb-lg-2">
                            ...
                            <div v-if="config.temp.mode === 5" class="openvpn pb-lg-2">
                                <div class="form-row pb-lg-2">
                                    ...
                                    <div class="col-md-12 custom-file">
                                        <input type="file" class="custom-file-input form-control" accept=".ovpn, .conf" id="ovpn-file" @change="importOvpnConfig">
                                        <label class="custom-file-label form-control" for="ovpn-file">Choose file</label>
                                    </div>
                                </div>
                                <div class="form-row pb-lg-2">
                                    <div class="col-md-12">
                                        <label>OVPN</label>
                                        <textarea class="form-control  text-left" style="font-size:14px" rows="10" v-model="config.temp.modes[5].profile.ovpn" required></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btnku btn-block third">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
