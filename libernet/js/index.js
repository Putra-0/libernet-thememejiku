const app = new Vue({
	...
	getWanNet() {
            return new Promise((resolve) => {
                axios.get('http://ip-api.com/json?fields=countryCode,isp').then((res) => {
                    this.wan_country = "(" + res.data.countryCode + ")"
	...
	this.getWanNet().then(() => this.intervalGetWanNet()).catch(() => this.intervalGetWanNet())
    }
})
